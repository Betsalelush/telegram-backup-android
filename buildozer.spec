...
requirements = python3,kivy==2.3.0,https://github.com/kivymd/KivyMD/archive/master.zip,materialyoucolor,exceptiongroup,asyncgui,telethon==1.36.0,sentry-sdk==1.40.0,pyjnius==1.6.1,requests,pyaes,rsa,pyasn1,pyshorteners
