...
requirements = python3,kivy==2.3.0,kivymd==2.0.1.dev0,materialyoucolor,exceptiongroup,asyncgui,asynckivy,telethon==1.36.0,sentry-sdk==1.40.0,pyjnius==1.6.1,requests,pyaes,rsa,pyasn1,pyshorteners,pillow
